...
if True:
    ...
    def writePhylip(self, fName=None, interleave=False, whitespaceSeparatesNames=True, flat=False, append=True, offset=1):
        ...
        gm = ['Alignment.writePhylip(fName=%s, interleave=%s, whitespaceSeparatesNames=%s, flat=%s, append=%s)' % (
            fName, interleave, whitespaceSeparatesNames, flat, append)]
